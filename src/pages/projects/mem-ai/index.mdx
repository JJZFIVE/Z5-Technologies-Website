...
I was present for most engineering and product meetings, and learned as much as quickly as possible. Here's a list overview of my contributions:
...
if Mem can provide value in meeting briefings." I spent the first week identifying the problem to solve and building up from there. To do this,
